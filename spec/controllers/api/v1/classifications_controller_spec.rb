...
def setup_create_request(workflow_id, set_member_subject_id)
  request.session = { cellect_hosts: { workflow_id.to_s => "example.com" } }
  params = { classification: { workflow_id: workflow.id,
  ...
  context "logged in user" do
    ...
    describe "#create" do
      ...
      it "should return 204" do
        setup_create_request(workflow.id, set_member_subject.id)
