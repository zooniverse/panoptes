...
ActiveRecord::Schema.define(version: 20140929125651) do
  ...
  add_index "user_subject_queues", ["user_id"], name: "index_user_subject_queues_on_user_id", using: :btree
  add_index "user_subject_queues", ["workflow_id"], name: "index_user_subject_queues_on_workflow_id", using: :btree
