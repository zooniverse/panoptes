...
ActiveRecord::Schema.define(version: 20150908162042) do
  ...
  add_index "aggregations", ["subject_id", "workflow_id"], name: "index_aggregations_on_subject_id_and_workflow_id", unique: true
  ...
  create_table "media", force: :cascade do |t|
    ...
    t.jsonb    "metadata"
    t.integer  "put_expires"
    t.integer  "get_expires"
  end
  ...
  create_table "set_member_subjects", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.decimal  "priority",       index: {name: "index_set_member_subjects_on_priority"}
    t.integer  "lock_version",   default: 0
