class Api::V1::UsersController < Api::ApiController
  ...
  allowed_params :update, :login, :display_name, :email, :credited_name,
   ...
   :beta_email_communication, :nasa_email_communication, :languages,
   :subject_limit, :upload_whitelist, :banned, :valid_email,
   :ux_testing_email_communication, :intervention_notifications
