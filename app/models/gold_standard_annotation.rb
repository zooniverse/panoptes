...
# used to provide accuracy feeback for users in specific Zooniverse
# projects. This this feeback mechanism changed from GS annotations to
...
# been retired and don't need this data for the feeback mechanism.
